...
import bgu.spl.mics.application.passiveObjects.Initialize;
...
public abstract class Subscriber extends RunnableSubPub {
     ...
     * @param callback The callback that should be callbackcalled when messages of type
     *                 {@code type} are taken from this Subscriber message
     *                 queue.
     */
